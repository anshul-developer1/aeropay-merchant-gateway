...
class AP_SDK_KeystoreDecryptor @Throws(CertificateException::class, NoSuchAlgorithmException::class, KeyStoreException::class, IOException::class)
constructor() {
    ...
    private fun initKeyStore() {
        keyStore = KeyStore.getInstance(AP_SDK_KeystoreManager.ANDROID_KEY_STORE)
        keyStore!!.load(null)
    }
