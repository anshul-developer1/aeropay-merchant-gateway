    ...
    fun hitServer(requestID: Int, callbackHandlerAPSDK: AP_SDK_ICommunicationHandler, requestObject : Any?) {
        object : AsyncTask<Void, Void, Any>() {
            ...
            override fun doInBackground(vararg p0: Void?): Any? {
                ...
                var credentialsProvider = object : CognitoCachingCredentialsProvider(mContext, AP_SDK_ConstantsStrings().aws_identitypool_id, Regions.US_EAST_1){}
            ...
            override fun onPostExecute(result: Any?) {
                ...
                if(requestID.equals(AP_SDK_DefineID().FETCH_MERCHANT_PROFILE)){
                    ...
                    if(statusCode.equals("1")){
                        ...
                        objModelManager.merchantProfileModelAPSDK = Gson().fromJson(stringOutput,
                    ...
                    if(statusCode.equals("1")){
                        var stringOutput = Gson().toJson(output)
                        objModelManager.merchantLocationsModelAPSDK = Gson().fromJson(stringOutput,
                    ...
                    if(statusCode.equals("1")){
                        var stringOutput = Gson().toJson(output)
                        objModelManager.merchantDevicesModelAPSDK = Gson().fromJson(stringOutput,
                    ...
                    if(statusCode.equals("1")){
                        var stringOutput = Gson().toJson(output)
                        objModelManager.APSDKRegisterMerchantDevices = Gson().fromJson(stringOutput,
